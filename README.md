...
1. テンプレートのフォルダをコピペして日付名フォルダを作成する<br>
  ヒント：<br>
    1. コピー元のテンプレートフォルダを作成してから、日付を取得して、テンプレートフォルダをコピペして日付名にする）
3. コピーしたテンプレート内にあるテキストファイル名にも日付を付ける（テンプレートフォルダ配下にあるテキストファイルの名前を変更する）
4. ファイル名に日付を入れたテキストファイルをメモ帳で開く（2のテキストファイル名を引数にメモ帳のプロセスを開く）
